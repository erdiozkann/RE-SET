      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-5">
          <div className="flex items-center justify-between">
            ...
            <span className="text-3xl font-bold text-purple-800">{stats.confirmed}</span>
          </div>
          <h3 className="text-sm font-medium text-purple-900 mt-2">Toplam Onaylı</h3>
        </div>
      </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-4 text-sm shrink-0">
                    <span className={`font-medium ${
                      formatDate(apt.date) === 'Bugün' ? 'text-green-600' : 

-- Hakkımda içeriklerini temizle ve yeniden ekle
...
-- Sertifikaları temizle ve varsayılanları ekle
...
-- Yöntemleri temizle ve varsayılanları ekle
...
-- Blog yazılarını temizle ve varsayılanları ekle
...
-- Hero içeriklerini temizle ve ekle
...
-- İletişim bilgilerini temizle ve ekle
...
-- Profil resimlerini temizle ve ekle

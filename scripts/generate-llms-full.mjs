...
async function generate() {
  ...
  let markdown = `# RE-SET — Şafak Özkan | Demartini Metodu Türkiye (Kapsamlı Veri Kümesi)

> Bu dosya, RE-SET platformundaki yöntemlerin ve blog yazılarının LLM indekslemesi için birleştirilmiş halini içerir.
...
`;
  ...
  markdown += `## YÖNTEMLERİMİZ

### 1. Demartini Metodu
Dr. John Demartini tarafından geliştirilen, 13 sorulu Değer Belirleme Süreci ve Quantum Collapse Process ile kişinin değer hiyerarşisini ortaya çıkaran, duygusal kutuplukları nötralize eden sistematik bir algı dengeleme yöntemidir.

### 2. Değer Belirleme Süreci (Value Determination Process)
Dr. John Demartini'nin 13 reflektif soru üzerinden bireyin gerçek değer hiyerarşisini ortaya çıkardığı süreç. Sosyal idealizmden bağımsız, davranışla doğrulanan içsel öncelik haritasıdır.

### 3. Quantum Collapse Process
Demartini Metodu içinde yer alan, duygusal kutuplukları (kızgınlık/hayranlık, suçluluk/gurur) nötralize eden algı dengeleme tekniğidir.
